...
export default function TapIn() {
    ...
    return (
        <div className="font-formular-regular text-mainblue w-[90%] mx-auto">
            {/* Tab Header */}
            <TabHeader
                name="SAMAHAN TAP-IN"
            />
            {/* Container for list items */}
            <div className="list-container py-8 px-16">
                {/* Main list */}
                <ol type="1" className="list-decimal pl-5 space-y-6">
                    <li><strong>Craft the concept paper for your event/activity. </strong>
                        ...
                        <Link href="/" target="_blank" rel="noopener noreferrer" className="hover:underline text-mainblue">Concept Paper Form</Link>
                    ...
                    <li><strong>Once approved, you may proceed with booking your desired venue. </strong>
                        ...
                        {/* Sublist 1 */}
                         <ol type="a" className="list-[lower-alpha] pl-5 mt-2 space-y-4">
                            ...
                            <li> 
                                <Link href= "https://library.addu.edu.ph/booking/" target="_blank" rel="noopener noreferrer" className="hover:underline text-mainblue">
