...
export default function ResourceGuide() {
  return (
    <section className="flex w-full flex-col items-center overflow-x-clip px-6 py-12 md:px-8 md:py-16 lg:px-12">
      ...
      <div className="relative mt-12 md:mt-16">
        <div className="pointer-events-none absolute left-1/2 top-1/2 z-0 h-[900px] w-[200vw] -translate-x-1/2 -translate-y-1/2 md:h-[700px] md:w-[1400px] lg:h-[800px] lg:w-[1600px]">
          <Image
        ...
        <div className="relative z-20 mx-auto flex flex-col items-center gap-4 md:flex-row md:justify-center md:gap-6 lg:gap-8">
          <div className="relative h-42 w-72 overflow-hidden rounded-2xl shadow-lg md:h-96 md:w-96">
            <Image
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            <div className="relative h-42 w-72 overflow-hidden rounded-2xl shadow-lg md:h-80 md:w-78">
              <Image
            ...
            <div className="relative h-42 w-72 overflow-hidden rounded-2xl shadow-lg md:h-64 md:w-64">
              <Image
