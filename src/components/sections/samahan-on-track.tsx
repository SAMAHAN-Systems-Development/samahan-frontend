...
export default function OnTrack() {
  ...
  const boxClasses = "w-full border-2 border-[#3b5998] bg-white flex items-center justify-center min-h-[5rem] px-4 text-center text-[#3b5998] text-sm font-medium z-10 p-4";
  ...
  return (
    <div className='text-mainblue font-formular-regular text-sm sm:text-base'>
      ...
      <div className='px-4 lg:px-0'>
                  ...
                  <tbody>
                      {venueData.map((item, index) => (
                          <tr key={index}>
                              ...
                              <td 
                                  className="py-3 px-4 text-sm text-center font-medium border-2 border-black" 
                              >
                                  {item.venue}
                              </td>
        ...
        <div>
          <div className='mt-7 lg:mt-12 font-formular-medium lg:hidden lg:uppercase text-2xl lg:text-3xl'>Sponsorship Guide</div>
          <div className='mt-7 lg:mt-12 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-3xl'>Sponsorship Guide</div>
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 1</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 1</div>
          <div className={`${indent_2} mt-3`}>
            ...
            >
              ...
              <tbody>
                ...
                <tr className="border-t-2 border-black">
                  <td 
                    className="py-4 px-4 align-center text-[13px] xs:text-sm font-medium border-r-2 border-black" 
                  >
                  ...
                  <td className="py-4 px-4 align-top text-[13px] xs:text-sm">
                    <ol className="list-decimal ml-6 space-y-2">
                      <li className="pl-1">Meeting for General Objectives with Main TWG
                        {/* Nested List a, b, c */}
                        <ol className="list-lower-alpha list-outside pl-6 mt-1">
                          <li className="pl-1">a. Timeline of Event</li>
                          <li className="pl-1">b. Needs and Wants of Main TWG for the Event</li>
                          <li className="pl-1">c. Planned Activities for the Event</li>
                      </ol>
                      </li>
                      <li className="pl-1">Meeting with Outsourcing and Media for Specific Packages</li>
                      <li className="pl-1">Meeting with Executives for Comments, Suggestions, and Approval</li>
                      <li className="pl-1">Assigning of Project Heads</li>
                      <li className="pl-1">Crafting of Matrix with Project Heads</li>
                    </ol>
                  </td>
                </tr>
                ...
                <tr className="border-t-2 border-black">
                  <td 
                    className="py-4 px-4 align-top text-[13px] xs:text-sm font-medium border-r-2 border-black" 
                  >
                    <ul className="list-disc ml-3 sm:ml-10 space-y-1">
                  ...
                  <td className="py-4 px-4 align-top text-[13px] xs:text-sm">
                    <ol className="list-decimal ml-6 space-y-2">
                      <li className="pl-1">Make Contract Templates for the packages.</li>
                    </ol>
                  </td>
                </tr>
              </tbody>
          ...
          <div className={`text-xl lg:text-lg lg:font-extrabold uppercase lg:font-formular my-3`}>
            Promotions
          </div>
          ...
          <div className="w-full text-black">
            ...
            <div className="block lg:hidden space-y-8">
              ...
              <div className="border-2 border-black bg-white">
                ...
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Company logo on promotion collaterals (Facebook Page)</div>
                  <div className="p-3 text-sm flex items-center">Largest possible size</div>
                </div>
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Space Opportunity at Arrupe Hall</div>
                  <div className="p-3 text-sm flex items-center">Booth (2x3m)</div>
                </div>
                <div className="grid grid-cols-2">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Certificate of Appreciation</div>
                  <div className="p-3 text-xl flex items-center"><Check className="w-5 h-5" /></div>
                </div>
              </div>
              ...
              <div className="border-2 border-black bg-white">
                ...
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Company logo on promotion collaterals (Facebook Page)</div>
                  <div className="p-3 text-sm flex items-center">2nd largest possible size</div>
                </div>
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Space Opportunity at Arrupe Hall</div>
                  <div className="p-3 text-sm flex items-center">Booth (2x3m)</div>
              ...
              <div className="border-2 border-black bg-white">
                ...
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Company logo on promotion collaterals (Facebook Page)</div>
                  <div className="p-3 text-sm flex items-center">3rd largest possible size</div>
                </div>
                ...
                <div className="grid grid-cols-2 border-b-2 border-black">
                  ...
                  <div className="p-3 text-sm block break-words">
                    One (1) Vertical Streamer (3ft by 5ft to be provided by the company/organization)
                  </div>
                </div>
                ...
                <tbody>
                  ...
                  <tr className="border-t-2 border-black">
                    <td className="py-3 px-4 text-left text-sm font-medium border-r-2 border-black">
                      Company logo on promotion collaterals (Facebook Page) for the Sadya on SAMAHAN Official FB Page.
                    </td>
                  ...
                  <tr className="border-t-2 border-black">
                    <td className="py-3 px-4 text-left text-sm font-medium border-r-2 border-black">
                      Space Opportunity at Arrupe Hall for three (3) days September 26–28, 2024.
                    </td>
                    <td className="py-3 px-4 text-left text-sm border-r-2 border-black">
                      Booth (2x3m)
                    </td>
          ...
          <div className={`text-xl lg:text-lg lg:font-extrabold uppercase lg:font-formular my-3`}>
            Advertisements 
            <span className="text-xl lg:text-lg lg:font-extrabold mt-1 lg:mt-0"> ON ALL SAMAHAN AND SAMAHAN SPONSORSHIPS SOCIAL MEDIA PLATFORMS: FACEBOOK, INSTAGRAM, AND TIKTOK</span>
          </div>
          ...
          <div className="w-full text-black">
            ...
            <div className="block lg:hidden space-y-8">
              ...
              <div className="border-2 border-black bg-white">
                ...
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Carousel Post</div>
                  <div className="p-3 text-sm flex items-center">Logo <Plus className="inline w-3 h-3 mx-1"/> 3 Photos</div>
                </div>
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Video Advertisement</div>
                  <div className="p-3 text-sm flex items-center">30s to 1min Video Ad</div>
                </div>
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Happening Now</div>
                  <div className="p-3 text-xl flex items-center"><Check className="w-5 h-5"/></div>
                </div>
                <div className="grid grid-cols-2 border-b-2 border-black">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">Post-Event Recognition</div>
                  <div className="p-3 text-xl flex items-center"><Check className="w-5 h-5"/></div>
                </div>
                <div className="grid grid-cols-2">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">User Generated Content</div>
                  <div className="p-3 text-sm flex items-center">Two (2) Videos (solo ad and all sponsors in one video)</div>
                </div>
              </div>
              ...
              <div className="border-2 border-black bg-white">
                ...
                <div className="grid grid-cols-2">
                  <div className="p-3 text-sm font-medium border-r-2 border-black">User Generated Content</div>
                  <div className="p-3 text-sm flex items-center">One (1) Video (all sponsors in one video)</div>
                </div>
              </div>
              ...
              <table className="min-w-full bg-white border-collapse border-2 border-black">
                ...
                <tbody>
                  ...
                  <tr className="border-t-2 border-black">
                    ...
                    <td className="py-3 px-4 text-left text-sm border-r-2 border-black">
                      Logo <Plus className="inline w-3 h-3  align-middle mx-1" /> 3 Photos
                    </td>
                    <td className="py-3 px-4 text-left text-sm border-r-2 border-black">
                      Logo <Plus className="inline w-3 h-3  align-middle mx-1" /> 3 Photos
                    </td>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 2</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 2</div>
          <div className='w-full flex justify-center'>
                ...
                <tr className="bg-[#FFBD59]">
                  ...
                  <td className="py-6 px-6 align-top text-[13px] xs:text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Project Heads will collate the specific plans needed for the Concept Paper.
                      </li>
                      <li className="pl-1">
                        Secretariat will make the Concept Paper within 3–4 days.
                      </li>
                      <li className="pl-1">
                        Project Heads must pass the Concept Paper by the 5th day before the week ends.
                        {/* Nested List */}
                        <ol className="list-[lower-alpha] list-outside pl-5 mt-1">
                          <li className="pl-1">
                            This will ensure a week of waiting period for approval.
                          </li>
                        </ol>
                      </li>
                      <li className="pl-1">
                        Right after the approval of the Concept Paper, Secretariat will work on the venue reservation.
                      </li>
                    </ol>
                  </td>
                </tr>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 3</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 3</div>
          <div className='w-full flex justify-center'>
              ...
              <tbody>
                ...
                <tr className="bg-[#38B6FF] border-2 border-black">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-[13px] xs:text-sm font-medium border-r-2 border-black">
                    ...
                    <div className={`xs:ml-11 mt-4 mb-2`}>In close coordination with:</div>
                    
                    <ul className={`xs:ml-11 list-disc list-outside pl-4 space-y-1`}>
                      <li>Directors</li>
                      <li>Legal</li>
                      <li>Secretariat</li>
                      <li>Finance</li>
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-[13px] xs:text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Project Heads will pass on the sponsorship letter to the Outsourcing Team.
                      </li>
                      <li className="pl-1">
                        Outsourcing team will prepare the GForms for requirement.
                      </li>
                      <li className="pl-1">
                        After initial preparation, contacting of Sponsors will begin with aid from Secretariat.
                        {/* Nested List */}
                      ...
                      <li className="pl-1">
                        Checking of requirements will be done by Outsourcing Team in close coordination with the Legal Team.
                      </li>
                      <li className="pl-1">
                        Signing of MOA will be done by Outsourcing Team in close coordination with the Legal Team and Finance Team.
                      </li>
                    </ol>
                    <p className="mt-4">
                      Note: Only the Outsourcing Team are allowed to contact the Sponsors.
                    </p>
                  </td>
                </tr>
                ...
                <tr className="bg-[#D84BAC] text-white">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-[13px] xs:text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Outsourcing will endorse the Sponsor to the Finance Team.
                      </li>
                      <li className="pl-1">
                    ...
                    <p className="mt-4">
                      Note: Finance Team are allowed to directly contact the Sponsor but only for Payment Inquiries.
                    </p>
                  </td>
                </tr>
              </tbody>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 4</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 4</div>
          <div className='w-full flex justify-center'>
              ...
              <tbody>
                ...
                <tr className="bg-[#FFDD57]">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-[13px] xs:text-sm font-medium border-b-2 border-black">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Project Heads will pass on the Sponsor Documents to the Operations Team.
                      </li>
                      <li className="pl-1">
                        Simultaneously, Operations Team will make:
                        {/* Nested List */}
                        <ol className="list-[lower-alpha] list-outside xs:ml-11 mt-1">
                          <li className="pl-1">The Entry Pass in close coordination with the Outsourcing Team</li>
                          <li className="pl-1">Equipment Request in close coordination with the Secretariat Team</li>
                        </ol>
                      </li>
                      <li className="pl-1">
                        The passing of documents will be made by the Operations Team or the Project Heads only.
                      </li>
                    </ol>
                    <p className="mt-4">
                ...
                <tr className="bg-[#83D7D8]">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-center text-[13px] xs:text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Review of Obligations with the Legal Team and Event Analyst.
                      </li>
                      <li className="pl-1">
                        Branding Meeting with Main TWG.
                      </li>
                      <li className="pl-1">
                        Marketing Scheme with the close coordination of the Legal Team and Event Analyst.
                      </li>
                      <li className="pl-1">
                        Postings with the close coordination of the Event Analyst Team.
                      </li>
                    </ol>
                  </td>
                </tr>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 5</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 5</div>
          <div className='w-full flex justify-center'>
              ...
              <tbody>
                ...
                <tr className="bg-[#D84BAC] text-white">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        Collection of Full Payment in close coordination with Operations and Legal Team
                      </li>
                    </ol>
                    ...
                    <div className="mt-4">
                      ...
                      <ul className="list-disc list-outside pl-5 mt-1 space-y-1">
                        ...
                        <li>A Grace Period is allowed until 2 weeks after event</li>
                      </ul>
                    </div>
                  </td>
                </tr>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 6</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 6</div>
          <div className='w-full flex justify-center'>
          ...
          <div className='mt-7 lg:mt-9 font-formular-regular lg:hidden lg:uppercase text-2xl lg:text-3xl'>Phase 7</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>Phase 7</div>
          <div className='w-full flex justify-center'>
            ...
            <table className="min-w-full border-collapse border-2 border-mainblue">
              ...
              <tbody>
                ...
                <tr className="bg-[#D84BAC] text-white border-b-2 border-mainblue">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      ...
                      <li className="pl-1">Contact sponsors who asked for grace period.</li>
                    </ol>
                  </td>
                </tr>
                ...
                <tr className="bg-[#605DC8] text-white border-b-2 border-mainblue">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">Sponsorship Report 3 Weeks after Event</li>
                    </ol>
                  </td>
                </tr>
                ...
                <tr className="bg-[#FAD2F4]">
                  ...
                  <td className="py-6 px-4 sm:px-6 align-top text-sm font-medium">
                    <ol className="list-decimal list-outside pl-4 space-y-1">
                      <li className="pl-1">
                        After the confirmation of non-compliance by the Sponsor, a meeting will be scheduled with:
                        {/* Nested List */}
                        <ol className="list-[lower-alpha] list-outside xs:pl-5 mt-1">
                      ...
                      <li className="pl-1">The Blacklisting will be confirmed.</li>
                    </ol>
                  </td>
                </tr>
              </tbody>
          ...
          <div className='mt-7 lg:mt-9 font-formular-medium lg:hidden lg:uppercase text-2xl lg:text-3xl'>CHED MEMO 63, SERIES OF 2017: POLICIES AND GUIDELINES FOR LOCAL OFF-CAMPUS ACTIVITIES</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>CHED MEMO 63, SERIES OF 2017: POLICIES AND GUIDELINES FOR LOCAL OFF-CAMPUS ACTIVITIES</div>
        ...
        <div>
          ...
          <div className={`${indent_1} text-xl lg:text-lg lg:font-semibold mt-6`}>
              ...
              {submissionSteps.map((step, index) => (
                <div key={index} className="flex flex-col items-center relative group">
                  ...
                  {index !== submissionSteps.length - 1 && (
                    <div className={`hidden lg:flex absolute -right-6 lg:-right-7 top-1/2 -translate-y-1/2 ${arrowColor}`}>
                      <ArrowRight size={24} />
                    </div>
                  )}
          ...
          <div className='mt-7 lg:mt-9 font-formular-medium lg:hidden lg:uppercase text-2xl lg:text-3xl'>‘DUNGOG’ SESSIONS</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>‘DUNGOG’ SESSIONS</div>
          <div className={`${indent_1} mt-3`}>
            Once or twice a month, the Office of Student Affairs, in partnership with the formation offices, will conduct monthly formation sessions.
          </div>
          <div className={`${indent_1} text-xl lg:text-lg lg:font-semibold mt-3`}>
            Offices included:
          </div>
          ...
          <div className='mt-7 lg:mt-9 font-formular-medium lg:hidden text-2xl lg:text-3xl'>Things to Remember:</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix text-2xl lg:text-2xl'>Things to Remember:</div>
          <ul className={`${indent_2} list-disc mt-2`}>
            <li>2 weeks before the final exams rule</li>
            <li>There will be times when concept papers will be catered LATE</li>
            ...
            <li>First year recruitments are still a no-go during the first sem</li>
          </ul>

          <div className='mt-7 lg:mt-9 font-formular-medium lg:hidden lg:uppercase text-2xl lg:text-3xl'>QR CODES FOR VARIOUS DOCUMENTS AND REFERENCES:</div>
          <div className='mt-7 lg:mt-9 hidden lg:block font-trapix lg:uppercase text-2xl lg:text-2xl'>QR CODES FOR VARIOUS DOCUMENTS AND REFERENCES:</div>
          <div className='flex flex-col lg:flex-row justify-center w-full gap-10 lg:gap-28 mt-10'>
            <div className='flex flex-col justify-center items-center'>
              ...
              <div className={`text-xl lg:text-lg lg:font-extrabold text-center uppercase lg:font-formular my-3`}>
                Concept Paper Form
              </div>
              <Link href="https://forms.gle/6Wcf8GL8rbGfq7cn9" target="_blank" rel="noopener noreferrer" className="underline lg:hidden -mt-3">
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <Link href="https://drive.google.com/file/d/1fmiJUR4pIgAGaQiimx5ucADJVcq0Gf8P/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="underline lg:hidden -mt-3">
                or access the document here
              </Link>
            </div>
            <div className='flex flex-col justify-center items-center'>
              ...
              <Link href="https://docs.google.com/document/d/1X_q_SyZl2NAcCsuohchCc8yfzLu-yaG8/edit?tab=t.0" target="_blank" rel="noopener noreferrer" className="underline lg:hidden -mt-3">
                or access the document here
              </Link>
            </div>
          </div>
