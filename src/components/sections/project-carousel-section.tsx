...
export default function ProjectCarouselSection() {
  return (
    <section className="relative w-full overflow-hidden py-12 md:py-16 lg:py-20">
      {/* Decorative tape background to match Academix page */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-1/2 top-1/2 h-[1000px] w-[260vw] -translate-x-1/2 -translate-y-1/2 sm:h-[900px] sm:w-[220vw] md:h-[650px] md:w-[1600px] lg:h-[750px] lg:w-[2000px] xl:h-[820px] xl:w-[2200px] 2xl:h-[600px] 2xl:w-[180vw]">
          <Image
            src="/images/tape-design/tape-1.png"
            alt="Decorative tape design"
            fill
            className="object-fill rotate-0"
            priority
          />
        </div>
      </div>
