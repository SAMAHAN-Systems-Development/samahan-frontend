...
export default function Navbar() {
  return (
    <div className="fixed top-0 z-50 w-full px-4 py-4 select-none sm:px-6 lg:px-10 xl:px-24 2xl:px-40">
      <details className="group relative lg:hidden">
        <summary className="list-none">
          <div className="flex items-center justify-start px-4 group-open:h-14 group-open:bg-mainblue sm:px-6">
            <div className="cursor-pointer p-2 text-white group-open:text-white">
        ...
        <div className="absolute top-14 right-0 left-0 z-40 mt-0 overflow-y-auto rounded-b-4xl bg-mainblue px-10 pb-6 text-white">
      ...
      <div className="hidden lg:block">
        <div className="mx-auto max-w-7xl">
          <div className="flex h-14 items-center justify-between rounded-full border border-blue1/70 bg-mainblue/80 py-7 lg:px-4 xl:px-8">
